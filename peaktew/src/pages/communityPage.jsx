    ...
    <>
      <section className="w-screen min-h-screen flex flex-col gap-20 px-[100px] py-20 overflow-x-hidden z-10">
        <motion.img
          src={ring}
          alt=""
          className="absolute top-[90%] right-[-250px] md:top-[90%] md:right-[-250px] max-md:hidden md:w-[min(80vw,400px)] lg:w-[min(80vw,500px)] xl:w-[min(100vw,700px)] opacity-100 overflow-hidden z-0"
          initial={{ rotate: 0 }}
          animate={{ rotate: 360 }}
        ...
        >
          <h1 className="text-[min(10vw,128px)] font-metro-600 text-[#6D28B2] mb-10 leading-none">
        ...
        >
          ...
          <motion.p
            className="font-metro-600 text-[#6D28B2] text-[min(8vw,70px)]"
          ...
          >
            <ol className="list-disc">
              ...
              <li>
                No hate speech, bullying, harassment, or discrimination of any
                kind.
              </li>
              <li>
                Respect differing opinions and engage in healthy, constructive
                conversations.
              </li>
            </ol>
          </motion.div>
          ...
          >
            <ol className="list-disc">
              ...
              <li>
                Avoid sharing personal information (e.g., home address,
          ...
          >
            <ol className="list-disc">
              ...
              <li>
                Be honest about your interests and intentions when connecting
                with others.
              </li>
            </ol>
          </motion.div>
          ...
          >
            <ol className="list-disc">
              ...
              <li>
                Keep conversations and posts appropriate for a community-driven
                platform.
              </li>
              <li>
                Respect others' privacy—do not share personal details or private
          ...
          >
            <ol className="list-disc">
              <li>
                Use the platform to build real friendships and meaningful
                connections.
              </li>
              <li>Avoid spam, self-promotion, or excessive solicitation.</li>
              <li>
                Participate in events and discussions with a positive and
          ...
          >
            <ol className="list-disc">
              <li>
                Do not use the platform for illegal activities, fraud, or harm
                to others.
              </li>
              <li>
                Respect intellectual property rights—do not share copyrighted
                material without permission.
              </li>
              <li>
                Adhere to all local laws and regulations while using the
                platform.
              </li>
            </ol>
          </motion.div>
          ...
          >
            <ul className="list-none">
              <li>
                ...
                please report them to our moderation team. We reserve the right
                to remove content, issue warnings, suspend accounts, or take
                further action if necessary to maintain a safe and welcoming
                environment.
              </li>
              <br />
              <li>
                By using PeakTew, you agree to uphold these guidelines and
                contribute to a positive community experience.
              </li>
              <br />
              <li>
                Let's build real friendships and a welcoming space—together!
              </li>
            </ul>
          </motion.div>
        </motion.div>
