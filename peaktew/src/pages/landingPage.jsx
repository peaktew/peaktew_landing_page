...
const LandingPage = () => {
  ...
  return (
    <div className="relative overflow-hidden transition-colors duration-500">
      ...
      <motion.section
        className="relative w-full h-[120vh] overflow-hidden pt-50"
        initial={{ opacity: 0 }}
      ...
      >
        <div className="container mx-auto px-4 text-center justify-items-center">
          ...
          <AnimatedText
            ...
            className="text-4xl md:text-6xl lg:text-7xl font-metro-600 font-bold leading-none bg-gradient-to-br from-[#ffffff] to-[#220239] via-[#420084] bg-clip-text text-transparent"
          />
          <AnimatedText
            text="change this?"
            delay={0.3}
        ...
        <div className="relative h-[1200px] md:h-[2000px] w-full overflow-hidden bg-white">
          ...
          >
            ...
            <div className="text-sm font-semibold text-[#220239] mb-1">
              Brilliant
            </div>
            <div className="text-xs text-[#220239] mb-4">
            ...
            <div className="flex items-center space-x-2">
              ...
              />
              <span className="text-xs text-[#220239] font-medium">
                Aananya J
              </span>
            </div>
          </motion.div>
      ...
      <motion.div
        className="w-full flex flex-col items-center justify-center px-4 py-8 bg-gradient-to-b from-[#ffffff] via-[#ffffff] to-[#ffffff]"
        initial={{ opacity: 0 }}
        whileInView={{ opacity: 1 }}
        viewport={{ once: true }}
        transition={{ duration: 0.8 }}
