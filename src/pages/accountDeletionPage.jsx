...
const AccountDeletionPage = () => {
  ...
  return (
    <>
      ...
      <div className="relative min-h-screen flex items-center justify-center px-4 py-16 overflow-hidden transition-colors duration-500 bg-white dark:bg-[#220239]">
        {/* Top Gradient */}
